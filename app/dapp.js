...
class App extends React.Component {
  ...
  render() {
    ...
    return (<div>
      <h3>Decentralized University</h3>
      <Tabs onSelect={this.handleSelect} activeKey={this.state.activeKey} id="uncontrolled-tab-example">
        <Tab eventKey={1} title={this._renderStatus('Courses', this.state.blockchainEnabled)}>
          <Blockchain/>
        </Tab>
        <Tab eventKey={2} title={this._renderStatus('Publish Course on IPFS', this.state.storageEnabled)}>
